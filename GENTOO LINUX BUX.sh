...
FFLAGS="-O2 -pipe"
MAKEOPTS="-j2"
USE="-doc -nls -multilib -verify-sig -test -fortran -cobol -ada -d"
...
echo "=sys-kernel/gentoo-sources-7.0.12-r1
...
MAKEOPTS=\"-j2\"
USE=\"wayland pulseaudio dbus openrc -nls -X -aqua -bluetooth -doc -docs -man -info -gtk-doc -gnome -kde -plasma -xfce -systemd -selinux -audit -test -debug -pie -multilib -fonts -themes -ncurses -caps -verify-sig\"
FEATURES="nodoc noinfo noman"
LC_MESSAGES=C.utf8
GENTOO_MIRRORS=\"http://gentoo.c3sl.ufpr.br/\"" > /mnt/gentoo/etc/portage/make.conf;
...
fi;" > /mnt/gentoo/home/bux/.bash_profile;

...
MAKEOPTS=\"-j2\"
USE=\"wayland pulseaudio dbus openrc -nls -X -aqua -bluetooth -doc -docs -man -info -gtk-doc -gnome -kde -plasma -xfce -systemd -selinux -audit -test -debug -pie -multilib -fonts -themes -ncurses\"
FEATURES="nodoc noinfo noman"
LC_MESSAGES=C.utf8
GENTOO_MIRRORS=\"http://gentoo.c3sl.ufpr.br/\"" > /mnt/gentoo/etc/portage/make.conf;
